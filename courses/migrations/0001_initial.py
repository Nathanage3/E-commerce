# Generated by Django 4.2.15 on 2024-10-28 07:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preview', models.FileField(upload_to='course/lessons/videos', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['mp4'])])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=255)),
                ('file', models.FileField(blank=True, null=True, unique=True, upload_to='course/lessons/videos', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['mp4'])])),
        ...
        migrations.AddField(
            model_name='course',
            name='rating',
            field=models.ManyToManyField(related_name='rated_courses', to='courses.rating'),
        ),
        migrations.AddField(
